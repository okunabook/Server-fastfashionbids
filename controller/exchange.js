...
exports.getdetail = async (req, res, next) => {
    ...
    try {
        const query = `
            SELECT users.fname,users.lname, store.id_store,store.store_name, store.store_brand, store.store_color, store.store_detail, store.store_img, sex.sexname, size.sizes, type.name AS typename,users.address,users.tel,users.id
            FROM list
